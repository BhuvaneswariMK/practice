...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User loggedIUser = userLoggedInService.getLoggedInUser();
        return testRequestQueryService.findByTester(loggedIUser);
        //throw new UpgradResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented"); // replace this line with your code
    }
